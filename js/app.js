(() => {
    ...
    function initSliders() {
        if (document.querySelector(".header-swiper__slider")) new core(".header-swiper__slider", {
    ...
    let openMenu = menu.querySelectorAll("._icon-expand_more");
    console.log(openMenu);
    openMenu.forEach((open => {
        open.addEventListener("click", active);
        function active(e) {
            open.classList.toggle("menu__item--active");
        }
    }));
    window["FLS"] = true;
    isWebp();
